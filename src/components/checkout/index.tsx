...
const CheckoutPage = () => {
  ...
  return (
    ...
    <div className="border border-white">
      <div className="max-w-[1300px] mx-auto  flex lg:px-0 md:px-10 sm:px-10 xs:px-4 pt-6 pb-14 lg:gap-40 md:gap-14 lg:flex-row md:flex-row sm:flex-col-reverse xs:flex-col-reverse mt-[100px] ">
        <div className="lg:w-[64%] sm:w-full ">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-8">
              ...
              <p className="text-[#7F7F7F] mb-6 font-semibold  text-[14px]">
              ...
              <div className="space-y-8">
                ...
                <div className="grid lg:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select className="mt-1 block w-full bg-[#F5F5F5] rounded-md p-4 outline-none focus:ring-0 text-[#ACACAC] ">
                ...
                <div className="grid lg:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="080000"
                      className="mt-1 block w-full bg-[#F5F5F5] rounded-md p-3 outline-none focus:ring-0"
                    />
                    {errors.postalCode && (
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="mt-1 block w-full bg-[#F5F5F5] rounded-md p-4 outline-none focus:ring-0 text-[#ACACAC]"
                    >
