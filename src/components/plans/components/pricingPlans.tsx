      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
        <div className="bg-black text-white p-6 rounded-[6px] border border-zinc-800 shadow-lg">
          ...
          <p className="text-gray-400 mt-2 ">
            For developers testing out <br /> Liveblocks locally.
          </p>
          <p className="text-3xl font-bold mt-4 ">Free</p>
          <button className="w-full mt-4 bg-[#0F0F10] hover:bg-gray-600 text-white py-2 px-4 rounded ">
        ...
        <div className=" text-white p-6 rounded-[6px] border border-zinc-800   relative bg-[url('/BackgroundShadow.png')] bg-cover bg-center bg-no-repeat ">
          ...
          <button className="w-full mt-4 bg-white text-black py-2 px-4 rounded">
            Sign up
          </button>
          <ul className="mt-6 space-y-2 text-gray-300 ">
            <li>&#10003; WebSocket infrastructure</li>
