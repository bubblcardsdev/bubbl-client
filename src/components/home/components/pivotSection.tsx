...
export default function PivotSection() {
  ...
  return (
    <div className="bg-black text-white w-full px-8 py-12 min-h-[70vh] flex overflow-hidden">
...
<TranslateYwithFadeIn>
   <h3 className="text-white text-center xs:pb-5 md:pb-2 text-[#828282] text-xs xs:text-base md:text-lg lg:text-xl font-semibold leading-relaxed max-w-6xl mx-auto px-4">
          Bubbl cards
        </h3>
