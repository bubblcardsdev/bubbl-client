...
import Cards from '../cardSection/cards/cards'
...
function CardSection() {
  ...
  return (
    <section id="productWhiteBg"
      className=' bg-white  card-section-parent-container  '>
      <div className=' px-[20px] py-8 lg:px-8 card-section-inner-container  '>
        <div className='w-full  card-section-header-container ml-2 '>
          {/* Search Bar */}
          <div className="flex flex-col mb-4 md:mb-0  lg:w-2/5 w-full ">
            <div className="flex items-center w-full  h-12 bg-[#F5F5F5]  rounded-xl   ">
              ...
              <input
                type="text"
                className="flex-grow  focus:outline-none bg-[#F5F5F5] rounded-[10px] focus:ring-0 px-2  text-black truncate card-section-search-placeholder inter w-full  "
