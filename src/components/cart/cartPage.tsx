...
const Cart = (props: any) => {
    ...
    return (
        <section className=''>
            <div className=' pt-32 pb-12 lg:px-16 md:px-12 sm:px-8 px-6 flex flex-col gap-y-10 mx-auto max-w-[1300px] '>
                <div className="flex flex-col lg:flex-row  gap-14">
                    ...
                    <div className="w-full h-fit flex flex-col gap-y-6 ">
                        ...
                        {cardsData.map((value: any) => (
                            <div key={value.id} className='flex items-center bg-white  w-full mt-10'>
                                ...
                                <div className='flex items-center flex-col sm:flex-row  px-4 gap-x-8 gap-y-2 w-full md:justify-between'>
                                    ...
                                    <div className=' flex  w-full gap-x-14 px-0 sm:px-0 xs:px-0 '>
                    ...
                    <div className=''>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 my-4 ">
                            {Products.map((product) => (
                                ...
                                >
                                    <div
                                        className="relative border bg-[#F3F3F3] rounded-[10px] hover:shadow-lg flex flex-col gap-4 gap-x-6 pb-2 mt-4   ">
